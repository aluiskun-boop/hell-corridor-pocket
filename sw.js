const CACHE='hell-corridor-v6-2';
const CORE=['./hell_corridor_iv.html','./manifest.webmanifest','./app-icon.svg','./demon_sprites.png','./environment_atlas.png','./equipment_sprites.png','./effects_pickups_atlas.png','./chainsaw_sprite.png','./stalker_sprites.png','./goyboy_faces.png','./hell_scenery.png','./infernal_props_atlas.png','./infernal_reign_theme.mp3','./demon_growl.mp3','./demon_attack.mp3','./demon_hurt.mp3','./demon_death.mp3','./boss_roar.mp3','./shooter_cast.mp3','./stalker_taunt1.m4a','./stalker_taunt2.m4a','./stalker_hidden.m4a','./stalker_attack.m4a','./stalker_hurt.m4a','./stalker_death.m4a'];
